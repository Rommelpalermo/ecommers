...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['image'])) {
    $uploadDir = 'uploads/';
    $fileName = 'laptop-ultra-professional.jpg';
    ...
    if ($_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($fileType, $allowedTypes)) {
            ...
            if (move_uploaded_file($_FILES['image']['tmp_name'], $uploadFile)) {
                $success = "✅ Laptop image uploaded successfully as: " . $fileName;
            } else {
...
$stmt = $pdo->prepare("SELECT * FROM products WHERE id = 2");
$stmt->execute();
...
<head>
    ...
    <title>Upload Laptop Image - Laptop Ultra</title>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h3><i class="fas fa-laptop"></i> Upload Laptop Image for Laptop Ultra</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        <label for="image" class="form-label">Select Laptop Image:</label>
                                        <input type="file" class="form-control" id="image" name="image" accept="image/*" required>
                                        <div class="form-text">Will be saved as: laptop-ultra-professional.jpg</div>
                                    </div>
                                ...
                                <div class="mt-3 p-3 bg-light rounded">
                                    ...
                                    <ul class="small mb-0">
                                        ...
                                        <li>Format: JPG, PNG, GIF, or WebP</li>
                                        <li>Show the laptop from a professional angle</li>
                        ...
                        <?php if ($product['main_image'] && file_exists('uploads/' . $product['main_image'])): ?>
                            <div class="mt-4">
                                ...
                                <img src="uploads/<?php echo $product['main_image']; ?>" 
                        ...
                        <div class="mt-4">
                            <h5>Quick Links:</h5>
                            <a href="product.php?id=2" class="btn btn-outline-primary me-2">
                        ...
                        <div class="mt-4 alert alert-info">
                            ...
                            <p class="mb-0">You can also manually save your laptop image as <code>laptop-ultra-professional.jpg</code> directly in the <code>uploads/</code> folder.</p>
                        </div>
                    </div>
                </div>
            </div>
